      ...
      <div class="container">
		...
		$sql = "SELECT * FROM addpayment ";
					...
					while($i < $num) 
					{
								...
								$a8=mysql_result($result,$i,"duecount");
								$a9=mysql_result($result,$i,"collectionamount");
								$a10=mysql_result($result,$i,"paymentreceipt");
			...
			?>
                    ...
                    <td><?php echo $a8; ?></td>
                    <td><?php echo $a9; ?></td>
                    <td><img src="payment/<?php echo $a10; ?>" title="<?php echo $a10; ?>" alt="1" width="242" height="172" border="0"></td>
