      ...
      <div class="container">
        <div class="row">
          ...
          <table width="1428" border="1">
            <tr>
              <td><div align="center">View Member Report </div></td>
            </tr>
            <tr>
              <td><div align="center">Select Group Name 
                  <?php 
			mysql_connect('localhost', 'root', '');
			mysql_select_db('womensgroup');
			$sql = "SELECT teamname FROM addmember";
			...
			echo "</select>";
		?>  
                <input type="submit" name="Submit" value="View Member">
              </div></td>
            </tr>
            <tr>
              <td><table width="1422" height="67" border="1">
                <tr>
		...
		$sql = "SELECT * FROM addmember where teamname='".$_POST['teamname']."' ";
					...
					while($i < $num) 
					{
								...
								$a9=mysql_result($result,$i,"duedate");
